...
public class VoltDBSimulation {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int totalTransactions = 1000; // Change this value as needed
    ...
    private static long simulateUserInteraction(org.voltdb.client.Client client) throws Exception {
        ...
        long productId = new Random().nextInt(100) + 1; // Assuming there are 1,000,000 products
        client.callProcedure(new NullCallback(), "RetrieveProductDetails", productId);

        // Write operation: Add a new order
        long customerId = new Random().nextInt(100) + 1; // Assuming there are 1,000,000 customers
        //client.callProcedure(new NullCallback(), "AddNewOrder", customerId, System.currentTimeMillis());

        // Read operation: Retrieve order details
        client.callProcedure(new NullCallback(), "RetrieveOrderDetails", customerId); // Assuming OrderID is same as CustomerID
